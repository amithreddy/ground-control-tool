...
class StabilityNumberTab():
    def __init__(self,ui,db):
        ...
        delegateForColumn = ['lineedit']
        self.table=controllers.generictableView(self.model,delegateForColumn)
        self.ui=ui
        layout = QtGui.QHBoxLayout()
        layout.addWidget(self.table)
...
class CriticalJSQTab():
    def __init__(self, ui, db):
        ...
        delegates= [ 'lineedit', 'lineedit', 'checkbox',  'checkbox']
